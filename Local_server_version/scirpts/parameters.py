...
"""
parameters.py --peaks=pathname --summits=pathname --reads==pathname --metadata=path --genome=genome_version
...
--genome=<str>                    Specifiying a genome version: hg19, hg38, mm9, mm10.
...
black_lists_dic={
    'hg19':'/picb/rsgeno/chenhj/test_docker_images/black_lists/hg19_blacklist.bed',
    'hg38':'/picb/rsgeno/chenhj/test_docker_images/black_lists/hg38_blacklist.bed',
    'mm9':'/picb/rsgeno/chenhj/test_docker_images/black_lists/mm9_blacklist.bed',
    'mm10':'/picb/rsgeno/chenhj/test_docker_images/black_lists/mm10_blacklist.bed'
}
...
def create_parameters_file(metadata,peaks,summits,reads,genome,typical_bin_size,out_dir,sequencing_type,keep_peaks_number=False):
...
def main():
    ...
    try:
        opts,args=getopt(argv[1:],'h',['peaks=','summits=','reads=','metadata=','genome=','typical_bin_size=','outdir=','keep_peaks=','sequencing_type=','help'])
        for i,j in opts:   
            if i=="-h" or i=="--help":
    ...
    create_parameters_file(metadata,peaks,summits,reads,genome,typical_bin_size,out_dir,sequencing_type,keep_peaks_number=False)
